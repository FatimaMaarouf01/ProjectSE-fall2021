		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
                    ...
                    <a href="#" class="btn btn-primary"  onclick="location.href='../Add Project/colorlib-regform-5/index.html'">Add New Project</a><br><br>
					<div class="table-wrap">
					    ...
					    <tbody>
					      <tr>
					        <th scope="row" class="scope" >Le Mall-Verdun</th>
					        <td>12/12/2019</td>
					        <td>12/12/2025</td>
					        <td><a href="#" class="btn btn-primary">View</a></td>
					      </tr>
					      <tr>
					        <th scope="row" class="scope" > City Centre-Dbayeh</th>
					        <td>15/6/2018</td>
					        <td>30/7/2024</td>
							<td><a href="#" class="btn btn-primary">View</a></td>
					      </tr>
