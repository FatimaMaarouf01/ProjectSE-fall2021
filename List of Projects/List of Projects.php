...
<html lang="en">
  <head>
	...
	<body>
		<td><a href="../LanPage/index.php"><input type="submit" value="Log out" class="btn btn-primary"></a></td>
						...
						<div class="table-wrap">
							...
							<tbody>
								...
								<tr>
									...
									<td><a class="btn btn-primary" href="../List of Project-Admin/projects/<?php echo $row["attachment"];  ?>">View</a></td>
