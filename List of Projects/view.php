...
if (isset($_GET['project_id'])) {
    ...
    $filepath = '../List of Project-Admin/projects/' . $file['title'];
    ...
    if (file_exists($filepath)) {
        ...
        header('Content-Length: ' . filesize('../List of Project-Admin/projects/' . $file['title']));
        readfile('../List of Project-Admin/projects/' . $file['title']);
